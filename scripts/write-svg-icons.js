    ...
    .each((index, element) => {
      if (
        ...
        $(element)
          .children()
          .first()
          .hasClass('ferui-i-outline--badged')
      ) {
        ...
        $(element)
          .children()
          .first()
          .hasClass('ferui-i-outline--alerted')
      ) {
        ...
        $(element)
          .children()
          .first()
          .hasClass('ferui-i-solid--alerted')
      ) {
...
const SOURCE_PATH = path.join(__dirname, '../dist/ferui-icons/shapes');
