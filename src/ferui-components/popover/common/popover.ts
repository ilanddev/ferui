...
export class Popover {
  ...
  constructor(private element: any, private forcedMarginTop?: number, private forcedMarginLeft?: number) {
  ...
  public anchor(
    ...
    const marginLeft = this.forcedMarginLeft ? this.forcedMarginLeft : parseInt(popoverComputedStyle.marginLeft, 10);
    const marginRight = parseInt(popoverComputedStyle.marginRight, 10);
    const marginTop = this.forcedMarginTop ? this.forcedMarginTop : parseInt(popoverComputedStyle.marginTop, 10);
