  ...
  describe('Time IO Service', () => {
    ...
    describe('Locale Formatting', function() {
      ...
      it('supports a method to convert a Date object to time string based on the locale', () => {
        ...
        const localeHelperServFR: LocaleHelperService = new LocaleHelperService('fr');
        const timeIOServFR: TimeIOService = new TimeIOService(localeHelperServFR);
        expect(timeIOServFR.toLocaleDisplayFormatString(date)).toBe('16:20:30');
