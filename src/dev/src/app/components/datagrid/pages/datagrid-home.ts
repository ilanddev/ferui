    ...
    <div class="container-fluid">
      <div class="row" style="max-width: 1200px">
        <div class="col-12">
          ...
          <p>
            In this article, we will walk you through the necessary steps to add FerUI datagrid to an existing Angular
            project, and configure some of the essential features of it. We will show you some of the fundamentals of the
            grid (passing properties, using the API, etc).
          </p>

          <h3>Add Datagrid to Your Project</h3>

          <p>
            Since the datagrid component is part of <code>@ferui-components</code> you just need to add FerUI to your project
            main module then you'll be able to use the component as a regular Angular component.
          </p>
          ...
          <p>
            ...
            (<code>columnDefs</code>) and the data (<code>rowData</code>). In our case, the column definitions contain 18
            columns; each column entry specifies at least the header label and the data field to be displayed in the body of
            the table.
          </p>
          ...
          <h2 class="mt-4">Enable Sorting And Filtering</h2>
          ...
          <p>
            ...
            The <code>sortType</code> property (which is an instance of <code>FuiFieldTypes</code>) control the data type for
            this columns. It can be either STRING, DATE or NUMBER. <br />
            The <code>sortComparator</code> property allow the devs to use their own sortingComparator to override the
            default ones. The comparator should implement the <code>FuiDatagridComparator</code> interface to work. <br />
          ...
          <p>
            After adding the property, you should be able to sort the grid by clicking on the column headers. Clicking on a
            header toggles through ascending, descending and no-sort. You can also do multi-sorting by pressing the
          ...
          <p>
            With this property set, the grid will display the Global Search + Filters combo. Pressing it will display a popup
            with filtering UI which lets you choose the kind of filter and the text that you want to filter by.
          </p>
          ...
          <p>
            ...
            <b>Text, Number, Date, Boolean, Custom</b> and <b>Global search filter</b> types. If it's not specified, the
            filter type used by default is the <b>Text</b> filter.
          </p>
          ...
          <p>
            The <code>filterFramework</code> represent how the filter will looks within the filters popup. You can create
            your own template and you just need to create a new Angular component that extend
          ...
          <h2 class="mt-4">Default column definition</h2>

          <p>
            In some cases, you may want to have a default column definition object that all your datagrids can use as
            default. It's pretty simple, you just need to create a column definition object that implement the
            FuiColumnDefinitions interface.
          </p>
