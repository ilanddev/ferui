    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col pt-2">
          ...
          <button class="btn btn-info btn-sm" (click)="sizeColumnsToFit()">Size columns to fit the grid</button>
          <button class="btn btn-info ml-2 btn-sm" (click)="autoWidthColumns()">Auto width all columns</button>
          <button class="btn btn-secondary ml-2 btn-sm" (click)="refreshGrid()">Refresh grid</button>
          <button class="btn btn-secondary ml-2 btn-sm" (click)="resetGrid()">Reset grid</button>
        </div>
      </div>
    </div>
  `,
