    ...
    <form fuiForm class="container-fluid" #demoForm="ngForm">
      ...
      >
        <p class="alert alert-primary mt-4">
          Note: All those components depends on Angular locale to format the date. Currently the locale is :
          <code>{{ locale }}</code
          >.
        </p>
        <br />
        ...
        >
          ...
          <p #description>
            If you want to get a Date object from this component just specify it by setting the
            <code>[fuiDate]</code> value to <code>FuiDatetimeModelTypes.DATE</code>. By default it will return a
        ...
        <default-template-content
          [disabled]="disabled"
          [model]="model"
          [code]="exampleCodes[14]"
          [examples]="examples"
          [results]="results"
          [idx]="14"
          [resultModelNames]="'fourteen'"
        >
        ...
        >
          <h5 #title>
            Default time input (filled with US formatted time string value). Returning a
        ...
        >
          <h5 #title>
            Default time input (filled with EU formatted time string value). Returning a
            <code>{{ locale }}</code> formatted string.
          </h5>
          <fui-time-container>
        ...
        <default-template-content
          [disabled]="disabled"
          [model]="model"
          [code]="exampleCodes[15]"
          [examples]="examples"
          [results]="results"
          [idx]="15"
          [resultModelNames]="'fifteen'"
        >
          <h5 #title>Error message handling (validation).</h5>
          <fui-time-container>
            <label>Time</label>
        ...
        <default-template-content
          [disabled]="disabled"
          [model]="model"
          [code]="exampleCodes[11]"
          [examples]="examples"
          [results]="results"
          [idx]="11"
          [resultModelNames]="'eleven'"
        >
        ...
        <default-template-content
          [disabled]="disabled"
          [model]="model"
          [code]="exampleCodes[12]"
          [examples]="examples"
          [results]="results"
          [idx]="12"
          [resultModelNames]="'twelve'"
        >
        ...
        <default-template-content
          [disabled]="disabled"
          [model]="model"
          [code]="exampleCodes[13]"
          [examples]="examples"
          [results]="results"
          [idx]="13"
          [resultModelNames]="'thirteen'"
        >
          ...
          <fui-datetime-container [showSeconds]="false">
            ...
            <input
              ...
              required
              name="thirteen"
              [fuiDatetime]="modelTypeDate"
              [(ngModel)]="model.thirteen"
            />
          </fui-datetime-container>
        </default-template-content>
        ...
        <default-template-content
          [disabled]="disabled"
          [model]="model"
          [code]="exampleCodes[16]"
          [examples]="examples"
          [results]="results"
          [idx]="16"
          [resultModelNames]="'sixteen'"
        >
