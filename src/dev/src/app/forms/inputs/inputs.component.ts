    ...
    <form fuiForm class="container-fluid" #demoForm="ngForm">
      <default-template-wrapper [pageTitle]="'Input Page'" [(disabled)]="disabled" [examples]="examples"
        ...
        <default-template-content [disabled]="disabled" [model]="model" [code]="exampleCodes[3]"
          ...
          <h5>Label, wrapper, <span class="text-danger">required</span> validator but <span
            class="text-danger">disabled</span> :</h5>
          <fui-input-container>
        ...
        <default-template-content [disabled]="disabled" [model]="model" [code]="exampleCodes[4]"
                                  [examples]="examples" [results]="results" [idx]="4" [resultModelNames]="'five'">
        ...
        <default-template-content [disabled]="disabled" [model]="model" [code]="exampleCodes[5]"
                                  [examples]="examples" [results]="results" [idx]="5" [resultModelNames]="'six'">
        ...
        <default-template-content [disabled]="disabled" [model]="model" [code]="exampleCodes[6]"
                                  [examples]="examples" [results]="results" [idx]="6" [resultModelNames]="'seven'">
