...
feruiShape['fui-filter'] = feruiIconSVG(`
  ...
  <path class="fui-filter-icon clr-i-outline--badged clr-i-outline-path-1" fill-rule="evenodd" d="M11.1 9.6c1 0 1.9.7 2.2 1.6h1c.4 0 .7.4.7.8s-.3.8-.8.8h-.9c-.3 1-1.2 1.6-2.2 1.6-1 0-1.9-.7-2.2-1.6H1.8A.8.8 0 0 1 1 12c0-.4.3-.8.8-.8h7.1c.3-1 1.2-1.6 2.2-1.6zM6.4 4c1 0 2 .7 2.2 1.6h3c.3.6.5 1 1.3 1.6H8.6c-.3 1-1.1 1.6-2.2 1.6-1 0-1.8-.7-2.2-1.6H1.8a.8.8 0 0 1-.8-.8c0-.4.3-.8.8-.8h2.4C4.6 4.6 5.4 4 6.4 4zM5 15.2c1 0 1.9.7 2.2 1.6h7.1c.5 0 .8.4.8.8s-.3.8-.8.8H7.1c-.3 1-1.2 1.6-2.2 1.6-1 0-1.9-.7-2.2-1.6h-1a.8.8 0 0 1-.7-.8c0-.4.3-.8.8-.8h.9c.3-1 1.2-1.6 2.2-1.6zm.8 2.4c0-.4-.4-.8-.8-.8s-.8.4-.8.8.4.8.8.8.8-.4.8-.8zm6.2-5.6c0-.4-.4-.8-.8-.8s-.8.4-.8.8.4.8.8.8.8-.4.8-.8zM7.2 6.4a.8.8 0 0 0-1.6 0c0 .4.4.8.8.8.5 0 .8-.4.8-.8z"/>
  <circle class="fui-filter-icon-circle clr-i-outline--badged clr-i-outline-path-2" fill-rule="evenodd" cx="15.5" cy="3.5" r="3.5"/>`);
