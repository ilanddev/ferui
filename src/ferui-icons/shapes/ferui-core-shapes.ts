...
feruiShape['fui-document-list'] = feruiIconSVG(`
<path class="fui-document-list-icon clr-i-outline clr-i-outline-path-1" fill-rule="evenodd" d="M11.814 0c.074.001.159.04.251.116l.07.064 5.374 5.374a.62.62 0 01.173.263l.008.057v12.123a2.01 2.01 0 01-1.854 1.997l-.149.006H4.003a2.01 2.01 0 01-1.997-1.854L2 17.996V2.004C2 .901 2.901 0 4.003 0h7.811zm-.245 1.602H4.003c-.217 0-.4.184-.4.401v15.994c0 .19.14.354.32.392l.08.009h11.684c.19 0 .354-.141.393-.322l.008-.08V6.12H12.37a.804.804 0 01-.795-.701l-.006-.1V1.602zM9.53 13.044a.626.626 0 01.89 0 .633.633 0 010 .893l-2.667 2.679a.626.626 0 01-.889 0l-1.333-1.34a.633.633 0 010-.893.626.626 0 01.888 0l.89.893zm0-5.357a.626.626 0 01.89 0 .633.633 0 010 .893l-2.667 2.68a.626.626 0 01-.889 0L5.531 9.92a.633.633 0 010-.893.626.626 0 01.888 0l.89.893zm2.84-6.139v3.77h3.77l-3.77-3.77z"/>
`);

feruiShape['fui-document'] = feruiIconSVG(`
<path class="fui-document-icon clr-i-outline clr-i-outline-path-1" fill-rule="evenodd" d="M12.37 5.319v-3.77l3.77 3.77h-3.77zM2 2.003C2 .901 2.901 0 4.003 0h7.811c.092.002.202.06.322.18l5.373 5.374c.119.119.18.229.181.32v12.123A2.009 2.009 0 0115.687 20H4.003A2.009 2.009 0 012 17.997V2.003zm1.602 15.994c0 .217.184.4.401.4h11.684c.217 0 .4-.183.4-.4V6.12H12.37a.803.803 0 01-.801-.801V1.602H4.003c-.217 0-.4.184-.4.401zm9.63-3.17H5.565a.67.67 0 100 1.339h7.667a.67.67 0 000-1.34zm0-3.571H5.565a.67.67 0 100 1.339h7.667a.67.67 0 000-1.34zm0-3.57H5.565a.67.67 0 100 1.338h7.667a.67.67 0 000-1.339z"/>
`);

feruiShape['fui-document-library'] = feruiIconSVG(`
<path class="fui-document-library-icon clr-i-outline clr-i-outline-path-1" fill-rule="evenodd" d="M6.364 1C7.85 1 9.17 1.707 10 2.8a4.55 4.55 0 013.422-1.795L13.636 1h5.455c.463 0 .846.343.902.787L20 1.9v13.5a.903.903 0 01-.795.893l-.114.007h-6.364a1.81 1.81 0 00-1.818 1.8c0 .557-.392.856-.812.895L10 19c-.422 0-.844-.259-.902-.776l-.008-.125-.005-.147A1.811 1.811 0 007.273 16.3H.909A.905.905 0 010 15.4V1.9c0-.497.407-.9.91-.9h5.454zm0 1.8H1.818v11.7h5.455c.662 0 1.283.175 1.818.482V5.5c0-1.491-1.221-2.7-2.727-2.7zm11.818 0h-4.546c-1.506 0-2.727 1.209-2.727 2.7v9.482a3.648 3.648 0 011.818-.482h5.455V2.8z"/>
`);

feruiShape['fui-document-file'] = feruiIconSVG(`
<path class="fui-document-file-icon clr-i-outline clr-i-outline-path-1" fill-rule="evenodd" d="M12.37 5.319v-3.77l3.77 3.77h-3.77zM2 2.003C2 .901 2.901 0 4.003 0h7.811c.092.002.202.06.322.18l5.373 5.374c.119.119.18.229.181.32v12.123A2.009 2.009 0 0115.687 20H4.003A2.009 2.009 0 012 17.997V2.003zm1.602 15.994c0 .217.184.4.401.4h11.684c.217 0 .4-.183.4-.4V6.12H12.37a.803.803 0 01-.801-.801V1.602H4.003c-.217 0-.4.184-.4.401z"/>
`);
