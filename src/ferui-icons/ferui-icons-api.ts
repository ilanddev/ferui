...
export class FeruiIconsApi {
  private static singleInstance: FeruiIconsApi;

  private constructor() {
  }

  static get instance(): FeruiIconsApi {
    if (!FeruiIconsApi.singleInstance) {
      FeruiIconsApi.singleInstance = new FeruiIconsApi();
    }

    return FeruiIconsApi.singleInstance;
  }
